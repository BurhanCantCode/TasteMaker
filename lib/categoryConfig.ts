...
export const CATEGORY_CONFIG: Record<string, CategoryConfig> = {
  product: {
    ...
    options: [
      { value: "nope", label: "Nope", sentiment: "negative" },
  ...
  restaurant: {
    ...
    options: [
      ...
      { value: "didnt_like", label: "Been there - didn't like", sentiment: "negative" },
    ],
  },
  location: {
    ...
    options: [
      ...
      { value: "been_meh", label: "Been there - meh", sentiment: "negative" },
    ],
  },
  movie: {
    header: "Suggested Movie",
    options: [
      { value: "skip", label: "Skip", sentiment: "negative" },
  ...
  book: {
    ...
    options: [
      { value: "not_for_me", label: "Not for me", sentiment: "negative" },
  ...
  band: {
    ...
    options: [
      { value: "not_my_style", label: "Not my style", sentiment: "negative" },
