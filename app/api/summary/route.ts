  ...
  try {
    ...
    const message = await anthropic.messages.create({
      ...
      system: [
        ...
        "",
        "DEMOGRAPHIC ANCHORING — read this carefully:",
        "- Pronouns. If gender confidence on one value is ≥ 0.70, use the matching pronouns (he/him or she/her). Below 0.70, use they/them exclusively. NEVER guess gender from cooking, caretaking, emotion words, aesthetic preferences, hobbies, or vibe — that is stereotype, not evidence. Demographic state is the only authority.",
        ...
        "- If gender / age / life-stage are weak across the board, write the portrait second-person ('You ...') instead of third-person. It sidesteps pronoun commitment entirely while still feeling personal. This is the correct fallback when the user has answered few or no demographic probes.",
        "",
